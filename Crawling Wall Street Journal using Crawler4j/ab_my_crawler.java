...
public class ab_my_crawler extends WebCrawler {
...
//    	System.out.println("header read:"+url);
    ...
    public boolean shouldVisit(Page referringPage, WebURL url) {
        ...
        boolean returnval =  !FILTERS.matcher(href).matches() && isValid && hasNotSeen;
    ...
    public void visit(Page page) {
    	...
    	System.out.println("---visiting "+visitcount+":"+url);
